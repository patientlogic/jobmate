# Contributing to JobMate

Thank you for your interest in contributing to JobMate! This document outlines the process and guidelines for contributing to this project. Please read it carefully before submitting any contributions.

## Table of Contents

- [Contributing to JobMate](#contributing-to-JobMate)
...
3. **Add the upstream remote:**
   ```bash
   git remote add upstream https://github.com/patientlogic/JobMate.git
   ```
...
- **Features** — Check the [open issues](https://github.com/patientlogic/JobMate/issues) for ideas, or propose a new one first.
...
Before filing a bug report, check if it has already been reported in the [issue tracker](https://github.com/patientlogic/JobMate/issues).
...
Open a [feature request issue](https://github.com/patientlogic/JobMate/issues/new) with:
...
If you have a question that isn't answered here, feel free to open a [discussion](https://github.com/patientlogic/JobMate/discussions) or an issue tagged `question`.

Thank you for helping make JobMate better!
